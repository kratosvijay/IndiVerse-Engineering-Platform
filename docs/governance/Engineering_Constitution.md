...
This constitution is a living document. Changes require an approved Architecture Decision Record (ADR) and must not be modified directly during feature development.
